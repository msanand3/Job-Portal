...
<body>
  <h2>ENTER THE REQUIRED DETAILS BELOW:-</h2>
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
            <form action="inputdetailcompanydb.php" method="post">
              ...
              <div class="form-group">
                    ...
                    <input type="text" name="job" placeholder="Enter here" class="form-control">
              </div>
              <div class="form-group">
                    <label>REQUIRED 10th STANDARD PERCENTILE</label>
                    <input type="text" name="10per" placeholder="Enter percentage here" class="form-control">
              </div>
              <div class="form-group">
                    <label>REQUIRED 12th STANDARD PERCENTILE</label>
                    <input type="text" name="12per" placeholder="Enter percentage here" class="form-control">
              </div>
              <div class="form-group">
                    <label>REQUIRED GRADUATION CPI</label>
                    <input type="text" name="cpi" placeholder="Enter CPI here" class="form-control">
              </div>
              <div class="form-group">
                    <label>REQUIRED NUMBER OF PROJECTS YOU WORKED</label>
